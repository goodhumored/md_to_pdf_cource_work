...
export default function CreateDocumentButton({ className }: { className?: string }) {
  const [state, formAction] = useFormState(handleCreateDocument, initialState);
      ...
      >
        <div className="bg-white px-8 py-6 rounded-2xl">
          <form action={formAction}>
            <div className="text-3xl">Создать документ</div>
            <input
