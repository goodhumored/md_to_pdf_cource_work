...
export default function TemplateItem({ className, template: tp, onDelete = () => { }, handlePreview = () => { } }: { className?: string; template: TemplateDTO, onDelete: () => void, handlePreview: () => void }) {
  return (
    <div
